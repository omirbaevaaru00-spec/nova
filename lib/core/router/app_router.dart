...
// import 'package:stiky/features/university_detail/ui/reviews_screen.dart';
...
//         path: '/university/:id',
//         builder: (_, state) =>
//             UniversityDetailScreen(id: state.pathParameters['id'] ?? ''),
//       ),
//       GoRoute(
//         path: '/university/:id/reviews',
//         builder: (_, state) =>
//             ReviewsScreen(universityId: state.pathParameters['id'] ?? ''),
//       ),
//       GoRoute(
...
//         builder: (_, __) => const ProfileEntryScreen(),
//       ),
//       GoRoute(
